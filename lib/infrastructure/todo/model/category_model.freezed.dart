...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'title') String categoryTitle});
}
...
class _$CategoryModelImpl
  ...
  const _$CategoryModelImpl(
      {@JsonKey(name: 'title') required this.categoryTitle});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CategoryModel(categoryTitle: $categoryTitle)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('categoryTitle', categoryTitle));
  }
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
          {@JsonKey(name: 'title') required final String categoryTitle}) =
      _$CategoryModelImpl;
